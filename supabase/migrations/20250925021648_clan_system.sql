...
-- Villages table should already exist from 000_villages_system.sql
-- with kage_user_id and max_clans columns included
...
DROP POLICY IF EXISTS "Kage can create clans" ON clans;
DROP POLICY IF EXISTS "Kage or leader can update clans" ON clans;
DROP POLICY IF EXISTS "Kage or leader can delete clans" ON clans;
DROP POLICY IF EXISTS "Members can read clan members" ON clan_members;
DROP POLICY IF EXISTS "System can insert clan members" ON clan_members;
DROP POLICY IF EXISTS "Leaders can update clan members" ON clan_members;
DROP POLICY IF EXISTS "Users can leave clan" ON clan_members;
DROP POLICY IF EXISTS "Users can read own applications" ON clan_applications;
DROP POLICY IF EXISTS "Leaders can read clan applications" ON clan_applications;
DROP POLICY IF EXISTS "Users can create applications" ON clan_applications;
DROP POLICY IF EXISTS "Users can update own applications" ON clan_applications;
DROP POLICY IF EXISTS "Leaders can update applications" ON clan_applications;
DROP POLICY IF EXISTS "Clan members can read posts" ON clan_board_posts;
DROP POLICY IF EXISTS "Clan members can create posts" ON clan_board_posts;
DROP POLICY IF EXISTS "Advisors can update posts" ON clan_board_posts;
DROP POLICY IF EXISTS "Leaders can delete posts" ON clan_board_posts;
...
DROP TRIGGER IF EXISTS trg_check_max_clans ON clans;
...
DROP TRIGGER IF EXISTS trg_check_max_advisors ON clan_members;
